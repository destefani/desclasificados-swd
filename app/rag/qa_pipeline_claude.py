"""Question answering pipeline using Claude (Anthropic)."""
...
def build_context(results: List[Dict[str, Any]], max_tokens: int = 6000) -> str:
...
def ask_question_claude(
    ...
    """End-to-end question answering pipeline using Claude.
